...
export default function MailchimpForm({ callBack, tags = '', hideOrg = false, hideRole = false }) {
    ...
    const onSubmit = (e) => {
        ...
        jsonp(
          `${formUrl}&EMAIL=${email}&FNAME=${firstName}&LNAME=${lastName}&ORG=${org}&ROLE=${role}&tags=${tags}`,
          { param: "c" },
          function (error, data) {
  ...
  return (
    <form onSubmit={onSubmit}>
      ...
      <div className="input-group" style={hideRole ? { display: "none" } : {}}>
      ...
      <div aria-hidden="true" style={{ position: "absolute", left: "-5000px" }}>
        <input
          type="text"
          name="b_1e88f3849531b2e943815a986_9c6a68827d"
          tabIndex="-1"
          value={honey}
